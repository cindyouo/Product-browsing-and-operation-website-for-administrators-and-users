                    ...
                    <div class="row product-content product-store">
                        ...
                        <div class="col-md-4">
                          <div class="product-wrapper text-center">
                              <a href="product1.php?id=<?php echo $product['id']; ?>" class="product-link" data-id="<?php echo $product['id']; ?>">
                                <img src="<?php echo $product['image']; ?>" alt="categories" class="product-image img-fluid">
                              </a>
                              <div class="product-content text-center">
                                  <h5 class="text-uppercase mt-3">
                                    <a href="product1.php?id=<?php echo $product['id']; ?>" class="product-link" data-id="<?php echo $product['id']; ?>"><?php echo $product['name']; ?></a>
                                  </h5>
