...
<?php
				if($_SESSION["admin"]=="admin_ok"){
          //echo"<h3><a href=\"classadmin.php\">課程管理</a></h3>";
          echo"<h3><a href=\"people.php\">會員管理</a></h3>";
          // echo"<h3><a href=\"formadmin.php\">表單管理</a></h3>";
          echo"<h3><a href=\"shopadmin.php\">商品管理</a></h3>";
				}
				else{
					echo" 你不是管理員，5秒跳回";
